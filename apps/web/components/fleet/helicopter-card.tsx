...
export function HelicopterCard({ helicopter }: HelicopterCardProps) {
  return (
    <a
      ...
      className="block rounded-lg border border-line bg-white/78 p-5 shadow-panel transition hover:-translate-y-0.5 hover:shadow-lg dark:bg-canvas-muted/72"
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <ArrowUpRight className="h-4 w-4 text-ink-subtle" aria-hidden="true" />
      </div>
      ...
      <div className="mt-5 rounded-md border border-line bg-canvas-muted/70 p-3">
