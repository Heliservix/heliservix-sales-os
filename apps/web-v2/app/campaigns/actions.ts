...
export async function createCampaign(formData: FormData) {
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      discharge_port: optionalText(formData, "dischargePort"),
      pilot_start_date: optionalText(formData, "pilotStartDate"),
      pilot_end_date: optionalText(formData, "pilotEndDate"),
      mechanic_start_date: optionalText(formData, "mechanicStartDate"),
      mechanic_end_date: optionalText(formData, "mechanicEndDate"),
